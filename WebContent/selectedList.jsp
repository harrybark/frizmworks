...
<link rel="stylesheet" href="css/selectedListPage.css" media="all" />
		...
		<div id="left-main">
			<div class="main-logo">
				<c:choose>
					...
					<c:otherwise>
						<a
							href="main.mo?memberId=${member.memberId }&memberPw=${member.memberPw}">
							<img src="img/logo_png_black.png" alt="mainlogo" />
						</a>
					</c:otherwise>
				</c:choose>
			</div>
		...
		<div id="right-main">
			...
			<div class="right_contents">
				<ul>
					...
					<li><a
						href="cartList.ca?memberId=${member.memberId }&memberPw=${member.memberPw}">CART</a></li>
					<li><a
						href="myInfo.mo?memberId=${member.memberId }&memberPw=${member.memberPw}">MY
							PAGE</a></li>
					<c:choose>
						<c:when test="${sessionScope.sessionId == null }">
			...
			<div class="contents">
				<jsp:include page="selectedListPage.jsp"></jsp:include>
			</div>
