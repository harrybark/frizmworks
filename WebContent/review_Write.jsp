...
<head>
<meta charset="UTF-8">
<title>Review Wirte page</title>
<link rel="stylesheet" href="css/reset.css" media="all" />
<link rel="stylesheet" href="css/reviewWrite.css" media="all" />
	...
	$(document).ready(
			function() {
				...
				$('.shop').click(
						function() {
							$('.shop_Contents').not(
									$(this).next('.shop_Contents').slideToggle(
											500)).slideUp();
						});
...
<body>
	<div id="main">
		...
		<div id="right-main">
			...
			<div class="contents">
				<jsp:include page="review_Writeform.jsp"></jsp:include>
			</div>
